...
export default function TransitionPage({ onContinue }) {
  return (
    <main className="min-h-screen bg-slate-100 dark:bg-slate-900">
      <div className="max-w-3xl mx-auto px-4 py-12 text-slate-800 dark:text-slate-200 text-center">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-6">
          Your Personalized Career Matches Are Ready
        </h2>

        <p className="text-sm leading-relaxed mb-4 dark:text-slate-300">
        ...
        <p className="text-sm leading-relaxed font-medium text-slate-900 dark:text-slate-100 mb-6">
